...
main_ptrn = "\s*([a-zA-Z_]\w*[(](\s*[a-zA-Z_]\w*[(]|[^()]+[)]|[)]))"
...
for file in onlyfiles:
    ...
    matches_main = re.findall(main_ptrn, sql_as_string)
    matches_fallback = re.findall(fallback_ptrn, sql_as_string)
    #print(onlyfiles)
    ''' create list of functions conversons to be made'''
    df_converted_func = convert_sql.create_map(matches_main, matches_fallback, dict_transaformed, file_name)
